...
| --- | --- | --- | --- | --- |
| accounts | [1.0.3](swagger-apis/accounts/1.0.3.yml) | [2.0.0](swagger-apis/accounts/2.0.0.yml) | [YAML](diffs/accounts/1.0.3_2.0.0-breaking-only.yml) | [YAML](diffs/accounts/1.0.3_2.0.0.yml) |
...
| capitalization-bonds | [1.0.0-rc1.0](swagger-apis/capitalization-bonds/1.0.0-rc1.0.yml) |  |  |  |
...
| consents | [1.0.3](swagger-apis/consents/1.0.3.yml) | [2.0.0](swagger-apis/consents/2.0.0.yml) | [YAML](diffs/consents/1.0.3_2.0.0-breaking-only.yml) | [YAML](diffs/consents/1.0.3_2.0.0.yml) |
| credit-cards | [1.0.4](swagger-apis/credit-cards/1.0.4.yml) | [2.0.0](swagger-apis/credit-cards/2.0.0.yml) | [YAML](diffs/credit-cards/1.0.4_2.0.0-breaking-only.yml) | [YAML](diffs/credit-cards/1.0.4_2.0.0.yml) |
| customers | [1.0.3](swagger-apis/customers/1.0.3.yml) | [2.0.0](swagger-apis/customers/2.0.0.yml) | [YAML](diffs/customers/1.0.3_2.0.0-breaking-only.yml) | [YAML](diffs/customers/1.0.3_2.0.0.yml) |
| exchange | [1.0.0](swagger-apis/exchange/1.0.0.yml) |  |  |  |
| financings | [1.0.4](swagger-apis/financings/1.0.4.yml) | [2.0.0](swagger-apis/financings/2.0.0.yml) | [YAML](diffs/financings/1.0.4_2.0.0-breaking-only.yml) | [YAML](diffs/financings/1.0.4_2.0.0.yml) |
| insurances | [1.0.0-rc1.0](swagger-apis/insurances/1.0.0-rc1.0.yml) |  |  |  |
| investments | [1.0.0](swagger-apis/investments/1.0.0.yml) |  |  |  |
| invoice-financings | [1.0.4](swagger-apis/invoice-financings/1.0.4.yml) | [2.0.0](swagger-apis/invoice-financings/2.0.0.yml) | [YAML](diffs/invoice-financings/1.0.4_2.0.0-breaking-only.yml) | [YAML](diffs/invoice-financings/1.0.4_2.0.0.yml) |
| loans | [1.0.4](swagger-apis/loans/1.0.4.yml) | [2.0.0](swagger-apis/loans/2.0.0.yml) | [YAML](diffs/loans/1.0.4_2.0.0-breaking-only.yml) | [YAML](diffs/loans/1.0.4_2.0.0.yml) |
...
| resources | [1.0.2](swagger-apis/resources/1.0.2.yml) | [2.0.0](swagger-apis/resources/2.0.0.yml) | [YAML](diffs/resources/1.0.2_2.0.0-breaking-only.yml) | [YAML](diffs/resources/1.0.2_2.0.0.yml) |
| unarranged-accounts-overdraft | [1.0.4](swagger-apis/unarranged-accounts-overdraft/1.0.4.yml) | [2.0.0](swagger-apis/unarranged-accounts-overdraft/2.0.0.yml) | [YAML](diffs/unarranged-accounts-overdraft/1.0.4_2.0.0-breaking-only.yml) | [YAML](diffs/unarranged-accounts-overdraft/1.0.4_2.0.0.yml) |
...
| acquiring-services | [1.0.0-rc1.0](swagger-apis/acquiring-services/1.0.0-rc1.0.yml) | [1.0.0](swagger-apis/acquiring-services/1.0.0.yml) | [YAML](diffs/acquiring-services/1.0.0-rc1.0_1.0.0.yml) |
...
| insurances | [1.0.0-rc1.0](swagger-apis/insurances/1.0.0-rc1.0.yml) |  |  |
| investments | [1.0.0-rc1.0](swagger-apis/investments/1.0.0-rc1.0.yml) | [1.0.0](swagger-apis/investments/1.0.0.yml) | [YAML](diffs/investments/1.0.0-rc1.0_1.0.0.yml) |
